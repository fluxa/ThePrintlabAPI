...
module.exports = function (app) {
    ...
    if (process.env.NODE_ENV === 'development' || process.env.NODE_ENV === 'test') {
        ...
        app.post('/v1/debug/coupons/reset/:client_id', debugapp.coupons_reset);
        app.get('/debug/coupon/test_save', debugapp.coupon_test_save);
        app.get('/debug/emails/queueorderconfirm', debugapp.queueup_order_confirm_email);
    }
